...
t.href=url;}}
function subp_nav_sidecar(m,i,a,t){var app=window.parent.SUGAR.App,url;if(!app.metadata.getModule(m).isBwcEnabled){a='';url="index.php?module="+m+"&action="+a+"&record="+i;url=app.view.views.BaseBwcView.prototype.convertToSidecarUrl(url);app.router.navigate(url,{trigger:true});return false;}}
