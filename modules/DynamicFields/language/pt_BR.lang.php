...
$mod_strings = array (
  ...
  'LBL_DONE' => 'Concluído',
  'LBL_DROPPING_COLUMN' => 'Soltando Coluna {0} de {1} para o módulo',
  ...
  'LBL_EXE_NON_SIM_MODE' => 'Executar o modo  não-simulação',
  'LBL_FIELD_MISSING' => 'Faltando Campo(s) de',
  'LBL_FIX_COLUMN_TYPE' => 'Arrumando Coluna Tipo para {0} trocando {1}  para',
  'LBL_FORMULA' => 'Fórmula',
  ...
  'LBL_SIMULATION_MODE' => 'Modo de simulacão - Nenhuma alteração será feita exceto limpar o CACHE',
