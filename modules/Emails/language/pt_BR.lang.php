...
$mod_strings = array (
  ...
  'ERR_MISSING_CREDENTIALS' => 'Erro: Faltando Credenciais',
  'ERR_MISSING_REQUIRED_FIELDS' => 'Faltam campos obrigatórios:',
  'ERR_MSG_FAILED' => 'Mensagem No : {0} falhou. Razão : Mensagem já foi importada',
  'ERR_NOT_ADDRESSED' => 'Erro: O e-mail deverá conter um endereço Para, Cc ou Bcc',
  'ERR_NO_IEID' => 'error: no ieID',
  'ERR_NO_UID' => 'error: no UID',
  'ERR_RCD_NUM_TO_DEL' => 'Um número de registro deve ser especificado para deletar o email.',
  ...
  'LBL_ASSIGNMNT_ACT_RESULT' => 'Resultado da Atribuição',
  ...
  'LBL_EXCEPTION' => 'Exceção Ocorrida',
  ...
  'LBL_ID_MISMATCH' => 'NOOP: ID não encontrado',
  ...
  'LBL_NOT_SUGAR_FOLDER' => 'NOOP: não é um Folder Sugar',
  'LBL_NO_FOLDER_TYPE' => 'NOOP: nenhum tipo de folder definido',
  'LBL_NO_GRAB_DESC' => 'Não existiam itens disponíveis. Por favor tente novamente.',
  'LBL_NO_SEARCH_CRITERIA' => 'NOOP: nenhum critério de busca encontrado',
