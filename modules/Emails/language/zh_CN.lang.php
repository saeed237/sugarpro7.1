...
$mod_strings = array (
  ...
  'ERR_MISSING_CREDENTIALS' => '错误：缺少凭据',
  'ERR_MISSING_REQUIRED_FIELDS' => '缺少必填字段',
  'ERR_MSG_FAILED' => '消息：{ 0 }失败。原因：消息已经导入',
  'ERR_NOT_ADDRESSED' => '错误:电子邮件必须要有收件人，抄送，或者密送地址。',
  'ERR_NO_IEID' => '无ieID',
  'ERR_NO_UID' => '无UID',
  'ERR_RCD_NUM_TO_DEL' => '一条纪录必须指定要删除的邮件。',
  'ERR_TIME_SENT' => '发送时间',
  'ERR_TIME_START' => '开始时间',
  ...
  'LBL_NOT_SENT' => '发送错误',
  'LBL_NOT_SUGAR_FOLDER' => '不是Sugar文件夹',
  'LBL_NO_FOLDER_TYPE' => '没有foldertype定义',
  'LBL_NO_GRAB_DESC' => '没有记录可以被使用。稍后再试。',
  'LBL_NO_SEARCH_CRITERIA' => '没有找到搜索标准',
  'LBL_NO_SUBJECT' => '(无主题)',
  'LBL_OF' => '的',
