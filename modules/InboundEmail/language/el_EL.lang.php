...
$mod_strings = array (
  ...
  'ERR_MAILBOX_FAIL' => 'Δεν θα μπορούσε να ανακτήσει οποιουσδήποτε λογαριασμούς ταχυδρομείου.',
  ...
  'LBL_ASSIGN_TO_GROUP_FOLDER_DESC' => 'Επιλογή για δημιουργία αυτόματων email εγγραφών στην Sugar για όλα τα εισερχόμενα μηνύματα..',
  ...
  'LBL_CERT_DESC' => 'Επικύρωση δύναμης του Πιστοποιητικού ασφαλείας του server - μην το χρησιμοποιήσετε αν αυτο-υπογράψετε.',
  ...
  'LBL_MODULE_NAME_SINGULAR' => 'Λογαριασμός Γκρουπ Ταχυδρομείου',
  ...
  'LBL_QUEUE' => 'Ουρά Αναμονής Λογαριασμού Ταχυδρομείου',
  'LBL_RE' => 'ΑΠ:',
  ...
  'LBL_SAVE_RAW_DESC_1' => 'Επιλέξτε "Ναι" εάν θα επιθυμούσατε να συντηρήσετε την ακατέργαστη πηγή για κάθε εισαγόμενο ηλεκτρονικό ταχυδρομείο.',
  ...
  'LBL_SERVER_URL' => 'Διεύθυνση Server Ταχυδρομείου',
  'LBL_SSL' => 'Χρήση SSL',
  ...
  'LNK_LIST_CREATE_NEW_BOUNCE' => 'Νέα Αναπήδηση Λογαριασμού Χειρισμού',
  'LNK_LIST_CREATE_NEW_GROUP' => 'Λογαριασμός Ταχυδρομείου Νέου Γκρουπ',
  'LNK_LIST_MAILBOXES' => 'Όλοι οι Λογαριασμοί Ταχυδρομείου',
