...
$mod_strings = array (
  ...
  'LBL_NAVIGATION_PARADIGM_DESCRIPTION' => '미리 지정된 그룹에 근거한 탐색바에 모듈 보기를 선택하십시오. 선택시 더보기 메뉴에서 필터 메뉴기능이 나타납니다.',
  ...
  'LBL_RESET_HOMEPAGE' => '홈페이지 재설정',
  'LBL_RESET_HOMEPAGE_WARNING' => '홈페이지를 재설정하시겠습니까?',
  'LBL_RESET_HOMEPAGE_WARNING_USER' => '이사용자의 홈페이지를 재설정 하시겠습니까?',
  ...
  'LBL_SUBPANEL_TABS' => '하위 패널 탭',
  'LBL_SUBPANEL_TABS_DESCRIPTION' => '세부내용보기에서 그륩 하위패널을 탭으로 한번에 하나의 탭을 전시합니다',
